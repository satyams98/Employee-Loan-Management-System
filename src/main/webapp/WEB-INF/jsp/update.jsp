    ...
    <div id="panelsStayOpen-collapseFamily" class="accordion-collapse collapse " aria-labelledby="panelsStayOpen-headingFamily">
      ...
      <c:forEach var="family" items="${employee.familyList}" >
          <div style="visibility:hidden">
            <input type='text' id = 'familyName' value="${family.name}" />
            <input type='text' id = "familyRelation" value="${family.relation}" />
            <input type="text" id = "familyContact" value="${family.contactNo}" />
            <input type="text" id="familyAdhaar" value = "${family.adhaarNo}" /> 
          </div>
