        ...
        <div class="middle">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <br>
                    <div id="familyContainer" style=" position: block; margin:1% 40% 0 1.5%; padding-right: 5%; width: 800px;"></div>
                </div>
...
$("#plus").click(() => {
        ...
        newFamily = '<div class="row" style=" border:thin solid #d9d5d4; padding:2% " id = family' + plusClicks + '>' + '     <div class="row">' +
                                                                                                                             ' <div class="col-md-3 input">' +
