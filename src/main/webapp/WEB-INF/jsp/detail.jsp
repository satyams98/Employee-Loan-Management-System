...
<nav class="navbar navbar-dark bg-transparent ">
  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      <br>
       <div class  id="loanDetails" >
      <c:forEach var="loan" items="${employee.loanAgreements}" >
      
         <div class="row">

            <div class="col ">
            <div class="input">
           <input type="text" class="input-field" id="loanAgreementId" name="loanAgreementId" value="${loan.loanAgreementId}"   readonly />
            ...
            <div class="col ">
            <div class="input">
           <input type="text" class="input-field" id="loanProductName" name="loanProductName" value="${loan.loanProduct.loanProductName}"   readonly />
            <label for="loanProductName" class="input-label">Loan Product</label>
            </div>
            </div>

             <div class="col input">
           <input type="text" class="input-field" id="loanAmount" name="loanAmount" value='<fmt:formatNumber value="${loan.loanAmount}" pattern="#.00"/>'  readonly />
            <label for="loanAmount" class="input-label">Loan Amount</label>
            </div>

             <div class="col input">
           <input type="text" class="input-field" id="tenure" name="tenure" value="${loan.tenure}"   readonly />
            <label for="tenure" class="input-label">Tenure</label>
            </div>

             <div class="col input">
           <input type="text" class="input-field" id="rate" name="rate" value="${loan.rate}"   readonly />
            <label for="rate" class="input-label">Rate</label>
            </div>

            
             <div class="col input">
           <input type="text" class="input-field" id="loanStatus" name="loanStatus" value="${loan.loanStatus}"   readonly />
            <label for="loanStatus" class="input-label">Loan Status</label>
            </div>
           <br>
           <hr>
           <br>
           ...
           <br>
           <br>
            <form action="/search" method='get'  style="position:relative; margin:-18% 0 0 42%;">
                <div class="col-md-3">
